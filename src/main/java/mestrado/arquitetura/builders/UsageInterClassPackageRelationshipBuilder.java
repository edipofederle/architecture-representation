...
public class UsageInterClassPackageRelationshipBuilder {
	...
	public UsageInterClassPackageRelationshipBuilder(ClassBuilder classBuilder, PackageBuilder packageBuilder){
		this.classBuilder = classBuilder;
		this.packageBuilder = packageBuilder;
	}


	public UsageInterClassPackageRelationship create(Usage element) {
