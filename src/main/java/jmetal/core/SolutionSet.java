        ...
        try {
            ...
            for (int i = 0; i < solutionsList_.size(); i++) {
                for (int j = 0; j < numberOfVariables; j++) {
                    ...
                    bw.newLine();
                    bw.newLine();
                    List<arquitetura.representation.Class> classes = new ArrayList<arquitetura.representation.Class>();
                    List<arquitetura.representation.Class> aspectos = new ArrayList<arquitetura.representation.Class>();
                    for (arquitetura.representation.Class classe : arch.getAllClasses()) {
                        if (classe.isAspect()) {
                            aspectos.add(classe);
                        } else {
                            classes.add(classe);
                    ...
                    bw.write("Number of classes: " + classes.size());
                    bw.newLine();
                    bw.newLine();
                    ...
                    List<AssociationRelationship> associations = new ArrayList<AssociationRelationship>();
                    List<AssociationRelationship> pointcuts = new ArrayList<AssociationRelationship>();
                    for (AssociationRelationship association : arch.getRelationshipHolder().getAllAssociationsRelationships()) {
                    ...
                    bw.newLine();
                    bw.newLine();
                    bw.write("Information about aspects (Ignore if you do not use aspects)");
                    bw.newLine();
                    bw.newLine();
                    bw.write("Number of aspects: " + aspectos.size());
                    bw.newLine();
                    bw.newLine();
                    bw.write("Number of pointcuts relationships: "
                            + pointcuts.size());
