...
public class ClassOperations extends XmiHelper {
	 ...
	 * @return
	 */
	public ClassOperations withMethod(final List<arquitetura.api.touml.Method> methods){
	 ...
	 * @return
	 */
	public ClassOperations withMethod(final arquitetura.api.touml.Method method){
		createMethod(method);
		return this;
	}

	private void createMethod(final arquitetura.api.touml.Method method) {
		arquitetura.api.touml.Document.executeTransformation(documentManager, new Transformation(){
			public void useTransformation() {
