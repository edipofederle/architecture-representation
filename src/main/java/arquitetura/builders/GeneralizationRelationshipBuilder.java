...
//		}
		...
		arquitetura.representation.Element general = architecture.getElementByXMIID(generalKlassId);
		arquitetura.representation.Element specific = architecture.getElementByXMIID(specificKlassId);
